...
As you can see, we have called out a couple key elements of the R script to discuss. @fig-example-script 
...
# We are not sure what's in the mtcars data. We are printing it below to take a look
mtcars

...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/exercise.jpg")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_01.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_02.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_03_correlation.png")
```

A value of 0 indicates that there is no linear correlation between the two variables. 

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_04_correlation.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_05_correlation.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_06_correlation.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/cont_cont_07_correlation.png")
```

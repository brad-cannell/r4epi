...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/flowchart_num_numerical.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/central_tendency_01.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/central_tendency_02.png")
```
...
👎 Additionally, it’s very possible to calculate a mean value that is not actually observed anywhere in your data. The mean value for the heights we just calculated above was 70.368; however, that number doesn't match even one of the values in the `heights` vector we created.
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/central_tendency_03.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/central_tendency_04.png")
```

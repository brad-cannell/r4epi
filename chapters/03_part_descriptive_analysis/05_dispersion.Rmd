...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_01_people.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_02_people.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_03_overview.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_04_edges.png")
```

Or are people “evenly distributed” across the range of heights for the class? 

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_05_even.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_06_variance.png")
```

Then, let’s measure the difference, or distance, between each person’s height and the mean height.

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_07_variance.png")
```

Then we square the differences. 

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_08_variance.png")
```

Then we add up all the squared differences.

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_09_variance.png")
```

And finally, we divide by n, the number of non-missing observations, minus 1. In this case n equals six, so n-1 equals five.

```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_10_variance.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_11_sd.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/dispersion_12_sd.png")
```
...
ggplot(data.frame(x = c(limits[1], limits[2])), aes(x = x)) + 

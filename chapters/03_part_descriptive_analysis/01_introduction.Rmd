...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/flowchart_num_and_cat.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/flowchart_num_only.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/flowchart_cat_only.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/03_part_descriptive_analysis/flowchart_full.png")
```

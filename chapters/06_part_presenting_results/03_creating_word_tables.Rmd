...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/table1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/row_header.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/subgroups.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/title.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/column_header.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/variables.png")
```

One row for the footer.

```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/footer.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_table.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/sample_size.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_column_headers.png")
```
...
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/what_stats.png")
```

```{r identify-stats, echo=FALSE, fig.cap="Identifying statistics in the row header."}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/identify_stats.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/bad_stat_labels.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/good_stat_labels.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_row_headers.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_data_values.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_title.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/number_footnotes.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/bad_footnote_1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/bad_footnote_2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_footnotes.gif")
```

At this point, your table should look like this in Microsoft Word:

```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_footnotes.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/adjust_columns.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/even_columns.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/merge_title.gif")
```

After merging the footnote cells in exactly the same way, your table should look like this:

```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_merged.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/remove_borders.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/06_part_presenting_results/03_creating_word_tables/make_borders.gif")
```

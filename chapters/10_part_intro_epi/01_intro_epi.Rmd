...
* Should we add a section on study design as in the PPT slides? Let's do that for now. Just get everything from the slides into the Rmd documents. We can make it better later.

* Change the name of the chapter from "Introduction to Epidemiology" to something else. We aren't really introducing epidemiology in this book. In fact, we specifically state that this book isn't a basic introduction to epidemiology. This chapter is really about what? Read it again and come back to finish this thought. Then, come up with a catchy title for the chapter. Here's the thing, after rereading this section, I think we are going to introduce some really basic, foundational concepts.

* Come back and define all of the bolded words in the appendix.
-->
...
```{r measures-of-occurrence-01, echo=FALSE}
# Don't actually use this image in the book. This code chunk is just here as a placeholder.
knitr::include_graphics("img/10_part_intro_epi/01_intro_epi/Slide1.png")
```

...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_01.png")
```
...
```{r measures-of-association-pop-10-exposed, echo=FALSE}
...
```{r measures-of-association-pop-10-exposed-plot, echo=FALSE}
...
ggsave(
  "img/10_part_intro_epi/04_measures_of_association/pop_10_exposed_plot.png",
  pop_10_exposed_plot, 
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/pop_10_exposed_plot.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_02.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_03.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_04.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_05.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/crosstab_06.png")
```
...
We are finally ready to get into measures of association. But, what is an association?



```{r measures-of-association-association, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/association.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/independence.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/independence_02.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/independence_03.png")
```

<!-- Add more context around the slides below -->

```{r measures-of-association-incidence-proportion-difference-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/incidence_proportion_difference_null.png")
```

```{r measures-of-association-incidence-proportion-ratio-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/incidence_proportion_ratio_null.png")
```

```{r measures-of-association-odds-ratio-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/odds_ratio_null.png")
```
...
<!-- Insert Alzheimer's stuff from hidden slides 13 and 14. Then delete them. -->

### Terminology recap

```{r measures-of-association-probability-terminology-recap, echo=FALSE}
...
<!-- Break up these slides somehow -->

```{r measures-of-association-measures-of-association-tree-01, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/measures_of_association_tree_01.png")
```

```{r measures-of-association-measures-of-association-tree-02, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/measures_of_association_tree_02.png")
```

```{r measures-of-association-measures-of-association-tree-03, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/measures_of_association_tree_03.png")
```
...
```{r measures-of-association-terminology-recap, echo=FALSE, eval=FALSE}
null_vallue_def <- ""
statistical_independence_def <- ""
association_def <- ""
incidence_prop_diff_def <- ""
incidence_prop_diff_other_terms <- "Risk difference"
incidence_prop_ratio_def <- ""
incidence_prop_ratio_other_terms <- "Risk ratio"
incidence_odds_def <- ""
incidence_odds_other_terms <- "Odds ratio"

measures_of_association_terminology_recap <- tribble(
  ~Term,                             ~Definition,                  ~`Examples and Notes`,
  "Null value",                      null_vallue_def,              "",
  "Statistical independence",        statistical_independence_def, "",
  "Association",                     association_def,              "",
  "Incidence proportion difference", incidence_prop_diff_def,      incidence_prop_diff_other_terms,
  "Incidence proportion ratio",      incidence_prop_ratio_def,     incidence_prop_ratio_other_terms,
  "incidence odds ratio",            incidence_odds_def,           incidence_odds_other_terms
)

knitr::kable(measures_of_association_terminology_recap)
```

So, how do we calculate these measures of association?
...
More commonly called relative risk or risk ratio <!-- Add to terminology table -->
...
```{r measures-of-association-incidence-proportion-ratio-crosstab, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/incidence_proportion_ratio_crosstab.png")
```

```{r measures-of-association-pop-10-exposed-plot-print-03, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/pop_10_exposed_plot.png")
```

<!-- Below is from the lab warm-up -->
...
More commonly called the risk difference

We like incidence proportion ratio because it is unambiguous and consistent with the previous terminology we have been using. 

```{r measures-of-association-incidence-proportion-difference-crosstab, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/incidence_proportion_difference_crosstab.png")
```

<!-- Above is from the lab warm-up -->
...
Calculate our incidence proportion difference
...
knitr::include_graphics("img/10_part_intro_epi/04_measures_of_association/incidence_odds_ratio_crosstab.png")
```
...
Calculate our incidence rate ratio
...
1.  Among the members of our population, those who were exposed had 1.5 times the rate of disease compared to those who were not exposed over the 12 months of follow-up period.
...
1.  Among the members of our population, those who were exposed had 0.03 additional cases of disease per person-month compared to those who were not exposed over the 12 months of follow-up period.

```{r}
ird * 100
```

2.  Among the members of our population, those who were exposed had 3.1 additional cases of disease per 100 person-months compared to those who were not exposed over the 12 months of follow-up period.

...
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/association.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/independence_02.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/independence_03.png")
```

<!-- Add more context around the slides below -->

```{r measures-of-association-incidence-proportion-difference-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/incidence_proportion_difference_null.png")
```

```{r measures-of-association-incidence-proportion-ratio-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/incidence_proportion_ratio_null.png")
```

```{r measures-of-association-odds-ratio-null, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/odds_ratio_null.png")
```
...
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/measures_of_association_tree_01.png")
```

```{r measures-of-association-measures-of-association-tree-02, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/measures_of_association_tree_02.png")
```

```{r measures-of-association-measures-of-association-tree-03, echo=FALSE}
knitr::include_graphics("img/10_part_intro_epi/05_measures_of_association/measures_of_association_tree_03.png")
```

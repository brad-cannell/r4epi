...
* We told the `freq_table()` function to create a univariate frequency table for the variable `sex_f`. A "univariate frequency table" just means a table (data frame) of useful statistics about a single categorical variable. What constitutes "useful" is sort of up to the person who creates the frequency table -- in this case, me.

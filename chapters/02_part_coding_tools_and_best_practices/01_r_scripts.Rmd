...
In R, the most basic type of code script is simply called an R script. An R script is just a plane text file that contains R code and comments. R script files end with the file extension `.R`. 
...
[Click here to download the R script](https://www.dropbox.com/s/3xmmlhnddk8vmqw/example_script.R?dl=0)

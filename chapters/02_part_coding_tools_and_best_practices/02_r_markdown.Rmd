...
[Click here to download the R markdown file](https://www.dropbox.com/s/bsrwzu0fud7634a/example_notebook.Rmd?dl=0)
...
[Click here to download the HTML notebook file](https://www.dropbox.com/s/qbu0nrgj559haut/example_notebook.nb.html?dl=0).
...
RStudio makes it very easy to create your own R markdown file. The process is actually really similar to the process we used to create an R script. Start by clicking on the icon shown below. \@ref(fig:new-r-markdown1)
...
🗒 Side note: When I say "interactive R coding" I mean, type some R code, submit, see the result, type some more R code, submit it, see the result... 

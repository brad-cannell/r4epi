...
The same logic applies to our R code. We often want to do the same (or very similar) thing to multiple times in our R code. This can result in many lines of code that are very similar and unnecessarily repetitive. This unnecessary repetition can occur in all phases of our projects.

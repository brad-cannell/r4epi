...
**Step 1:** Regardless of which operating system you are using, please make sure you computer is on, properly functioning, connected to the internet, and has enough space on your hard drive to save R and RStudio.
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide3.png")
```

**Step 3:** Click on Download R for (Mac) OS X.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide4.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide5.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide6.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide7.png")
```

If R installed properly, you should now see it in your applications folder.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide8.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide9.png")
```

**Step 8:** Download the most current version for Mac.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide10.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide11.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide12.png")
```

You should now see RStudio in your Applications folder. Double click the icon to open RStudio.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide13.png")
```

If this warning pops up, just click Open.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide14.png")
```

The RStudio IDE should open and look something like the window you see here. If so, you are good to go! 🎉

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_mac/Slide15.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide3.png")
```

**Step 3:** Click on Download R for Windows.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide4.png")
```

**Step 4:** Click on the base link.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide5.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide6.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide7.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide8.png")
```

If R installed properly, you should now see it in the Windows start menu.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide9.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide10.png")
```

**Step 9:** Download the most current version for Windows.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide11.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide12.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide13.png")
```

When RStudio is finished installing, you should see RStudio in the Windows start menu. Click the icon to open RStudio.

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide14.png")
```

The RStudio IDE should open and look something like the window you see here. If so, you are good to go! 🎉

```{r echo=FALSE}
knitr::include_graphics("img/getting_started/01_install_r/install_r_windows/Slide15.png")
```

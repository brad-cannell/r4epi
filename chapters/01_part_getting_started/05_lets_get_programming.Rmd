...
First, tibbles are a part of the `tibble` package -- NOT base R. Therefore, we have install and load either the `tibble` package or the `dplyr` package (which loads the tibble package for us behind the scenes) before we can create tibbles. I typically just load the `dplyr` package. 

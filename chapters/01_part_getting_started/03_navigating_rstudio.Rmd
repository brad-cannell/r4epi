...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/rstudio.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/console.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/one_plus_one.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/seq_function.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/environment_pane.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/environment_pane2.png")
```
...
🗒‼️ Side note: R is a **case sensitive** language. That means that upper case x (X) and lower case x (x) are different things to R. So, if you assign 2 to lower case x (`x <- 2`). And then later ask R to tell what number you stored in upper case X, you will get an error (`Error: object 'X' not found`).
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/files_pane.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/help.png")
```
...
```{r source1, echo=FALSE, fig.cap="Click the new source document icon."}
knitr::include_graphics("img/getting_started/03_navigating_rstudio/source1.png")
```

If you click any of these options, a new pane will appear. I will arbitrarily pick the first option – R Script. 

```{r source2, echo=FALSE, fig.cap="New source document options."}
knitr::include_graphics("img/getting_started/03_navigating_rstudio/source2.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/source3.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/preferences1.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/preferences2.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/preferences3.png")
```
...
knitr::include_graphics("img/getting_started/03_navigating_rstudio/preferences4.png")
```

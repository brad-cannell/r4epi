...
```{r}
#| label: intro-repeated-operations-competencies-overview
#| echo: FALSE
#| fig-cap: Project phases
...
```{r}
#| label: intro-repeated-operations-four-methods
#| echo: FALSE
#| fig-cap: Four methods for removing unnecessary repetition

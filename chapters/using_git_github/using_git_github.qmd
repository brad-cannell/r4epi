...
To preview:
bookdown::preview_chapter("using_git_github/using_git_github.qmd")
...
[In the previous chapter](../intro_git_github/intro_git_github.qmd), we discussed _why_ we should consider learning to use git and GitHub as part of our workflow when our projects include data and/or coding. In this chapter, we will begin to talk about _how_ to use git and GitHub. We will also introduce a third tool, GitKraken, that makes it easier for us to use git and GitHub.

## Install git

Before we can use git, we will need to install it on our computer. The following chapter of Pro Git provides instructions for installing git on Linux, Windows, and MacOS operating systems: [Get Started Installing Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git). 
...
```{r}
#| label: gikraken_01_home
#| echo: FALSE
knitr::include_graphics("gitkraken_01_home.png")
```

Next, you will need to click on the “Try Free” button. Then, download and install the GitKraken Client to your computer.

```{r}
#| label: gitkraken_02_client
#| echo: FALSE


knitr::include_graphics("gitkraken_02_client.png")
```
...
```{r}
#| label: gitkraken_03_github
#| echo: FALSE


knitr::include_graphics("gitkraken_03_github.png")
```

Then click the green `Continue authorization` button. 

```{r}
#| label: gitkraken_04_authorize
#| echo: FALSE


knitr::include_graphics("gitkraken_04_authorize.png")
```
...
```{r}
#| label: gitkraken_05_success
#| echo: FALSE


knitr::include_graphics("gitkraken_05_success.png")
```
...
```{r}
#| lable: gitkraken_06_repo_tab
#| echo: FALSE

knitr::include_graphics("gitkraken_06_repo_tab.png")
```
...
If you haven't already done so, please read the [contributing to R4Epi portion of the book's welcome page](../contributing/contributing.qmd). This will give you a gentle introduction to using GitHub, for a very practical purpose, without even needing to use git or GitKraken. 

## Example 2: Create a repository for a research project

In this example, we will learn how to create our very own git and GitHub repositories from scratch. We can immediately begin using the lessons from this example for our research projects -- even if we aren't collaborating with others on them. Remember, [there are at least four overarching reasons](../intro_git_github/intro_git_github.qmd) why you should consider learning to use git and GitHub as part of your workflow for your projects, and collaboration is only one of them. Not to mention the fact that it is often useful to think of our future selves as other collaborators, which we have mentioned and/or alluded to many times in this book. 
...
```{r}
#| label: repositories_01
#| echo: FALSE
#| fig.cap: GitHub repositories compared to Dropbox.


knitr::include_graphics("repositories_01.png")
```

::: callout-warning
Just because we _can_ upload data to GitHub doesn't mean we _should_ upload data to GitHub. Often, the data we use in epidemiology contains [protected health information](https://privacyruleandresearch.nih.gov/pr_07.asp) (PHI) that we must go to great lengths to keep secure. In general, GitHub is **NOT** considered a secure place to store our data and should not be used for this purpose. Below, we will demonstrate how to make sure our data isn't uploaded to GitHub with the rest of the files in our repository.
:::
...
```{r}
#| label: new_repository_01_create
#| echo: FALSE


knitr::include_graphics("new_repository_01_create.png")
```
...
```{r}
#| label: new_repository_02_setup
#| echo: FALSE


knitr::include_graphics("new_repository_02_set_up.png")
```
...
```{r}
#| label: new_repository_03_files
#| echo: FALSE


knitr::include_graphics("new_repository_03_files.png")
```
...
```{r}
#| label: new_repository_04_about
#| echo: FALSE


knitr::include_graphics("new_repository_04_about.png")
```
...
```{r}
#| label: new_repository_05_readme
#| echo: FALSE


knitr::include_graphics("new_repository_05_readme.png")
```

Now, Arthur has a working GitHub repository up and running. Let's pause for a moment to and celebrate! 🎉 

Okay, celebration complete. Now, what does he do with this new GitHub repository? Well, he does the four things covered in [Introduction to git and GitHub](../intro_git_github/intro_git_github.qmd)
...
```{r}
#| label: new_repository_07_commit_history
#| echo: FALSE
#|
knitr::include_graphics("new_repository_07_commit_history.png")
```
...
```{r}
#| label: new_repository_08_commit_details_01
#| echo: FALSE


knitr::include_graphics("new_repository_08_commit_details_01.png")
```
...
```{r}
#| label: new_repository_08_commit_details_02
#| echo: FALSE


knitr::include_graphics("new_repository_08_commit_details_02.png")
```
...
```{r}
#| label: new_repository_08_commit_details_03
#| echo: FALSE


knitr::include_graphics("new_repository_08_commit_details_03.png")
```
...
```{r}
#| label: new_repository_08_commit_details_04
#| echo: FALSE


knitr::include_graphics("new_repository_08_commit_details_04.png")
```

Finally, clicking the green `Comment on this commit` button adds our comment to the commit details page.

```{r}
#| label: new_repository_08_commit_details_05
#| echo: FALSE


knitr::include_graphics("new_repository_08_commit_details_05.png")
```
...
```{r}
#| label: fig-github-cloud 
#| echo: FALSE 
#| fig.cap: GitHub Cloud.


knitr::include_graphics("new_repository_09_github_cloud.png")
```
...
```{r}
#| label: new_repository_10_clone_01
#| echo: FALSE


knitr::include_graphics("new_repository_10_clone_01.png")
```
...
```{r}
#| label: new_repository_10_clone_02
#| echo: FALSE
knitr::include_graphics("new_repository_10_clone_02.png")
```
...
```{r}
#| label: new_repository_11_view_folder 
#| echo: FALSE


knitr::include_graphics("new_repository_11_view_folder.png")
```

Second, he should be able to open a tab in GitKraken with all the versioning information about his repository. 

```{r}
#| label: new_repository_12_view_folder_01
#| echo: FALSE
knitr::include_graphics("new_repository_12_view_gitkraken_01.png")
```
...
{{< video https://www.youtube.com/embed/RiAeNSFjjLc >}}
...
```{r}
#| label: new_repository_12_view_gitkraken_02
#| echo: FALSE


knitr::include_graphics("new_repository_12_view_gitkraken_02.png")
```
...
```{r}
#| label: new_repository_12_view_gitkraken_03
#| echo: FALSE


knitr::include_graphics("new_repository_12_view_gitkraken_03.png")
```
...
```{r}
#| label: new_repository_12_view_gitkraken_04
#| echo: FALSE
knitr::include_graphics("new_repository_12_view_gitkraken_04.png")
```

### Step 3: Add an R project file to the repository {-}

This step is technically optional, but we highly recommend it! We introduced [R projects](../r_projects/projects.qmd) earlier in the book. Arthur will go ahead and add an R project file to his repository now. This will make his life easier later. To create a new R project, he just needs to click the drop-down arrow next to the words `Project: (None)` to open the projects menu. Then, he will click the `New Project...` option.

```{r}
#| label: new_repository_13_new_project_01
#| echo: FALSE


knitr::include_graphics("new_repository_13_new_project_01.png")
```
...
```{r}
#| label: new_repository_13_new_project_02
#| echo: FALSE
knitr::include_graphics("new_repository_13_new_project_02.png")
```
...
```{r}
#| label: new_repository_13_new_project_03
#| echo: FALSE
knitr::include_graphics("new_repository_13_new_project_03.png")
```
...
```{r}
#| label: new_repository_14_gitignore_01
#| echo: FALSE
knitr::include_graphics("new_repository_14_gitignore_01.png")
```

Arthur will now open the `.gitignore` file and see what's there.

```{r}
#| label: new_repository_14_gitignore_02
#| echo: FALSE


knitr::include_graphics("new_repository_14_gitignore_02.png")
```
...
```{r}
#| label: new_repository_14_gitignore_03
#| echo: FALSE
knitr::include_graphics("new_repository_14_gitignore_03.png")
```
...
```{r}
#| label: new_repository_15_commit_01
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_01.png")
```
...
```{r}
#| label: new_repository_15_commit_02
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_02.png")
```
...
```{r}
#| label: new_repository_15_commit_03
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_03.png")
```

Next, Arthur will write a commit message. Just like there are [best practices for writing R code](../best_practices/best_practices.qmd), there are also best practices for writing commit messages. Here is a link to a blog post that we think does a good job of explaining these best practices: <https://cbea.ms/git-commit>. 
...
```{r}
#| label: new_repository_15_commit_04
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_04.png")
```

And here is what his GitKraken screen looks like after committing.

```{r}
#| label: new_repository_15_commit_05
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_05.png")
```
...
```{r}
#| label: new_repository_15_commit_06
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_06.png")
```
...
```{r}
#| label: new_repository_15_commit_07
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_07.png")
```
...
```{r}
#| label: new_repository_15_commit_08
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_08.png")
```
...
```{r} 
#| label: new_repository_15_commit_09
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_09.png")
```
...
```{r}
#| label: new_repository_15_commit_10
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_10.png")
```

Let's quickly pause and recap what Arthur has done so far. 

```{r}
#| label: new_repository_15_commit_11
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_11.png")
```
...
```{r}
#| label:  new_repository_15_commit_12
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_12.png")
```

After doing so, we will once again see some changes. What changes do you notice in the screenshot below?

```{r}
#| label:  new_repository_15_commit_13
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_13.png")
```
...
```{r}
#| label:  new_repository_15_commit_14
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_14.png")
```
...
```{r}
#| label:  new_repository_15_commit_15
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_15.png")
```

In the commit history, he can now see commit `4a394b7`. Let's take another pause here and recap.

```{r}
#| label:  new_repository_15_commit_16
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_16.png")
```
...
```{r}
#| lable:  new_repository_15_commit_17
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_17.png")
```
...
```{r}
#| lable:  new_repository_15_commit_18
#| echo: FALSE
knitr::include_graphics("new_repository_15_commit_18.png")
```
...
```{r}
#| lable:  new_repository_15_commit_19
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_19.png")
```

After saving the updated `.gitignore` file, the commit pane in GitKraken changes once again.

```{r}
#| label: new_repository_15_commit_20
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_20.png")
```
...
```{r}
#| label: new_repository_15_commit_21
#| echo: FALSE


knitr::include_graphics("new_repository_15_commit_21.png")
```
...
```{r}
#| label: new_repository_16_add_code
#| echo: FALSE


knitr::include_graphics("new_repository_16_add_code.png")
```
...
```{r}
#| label: new_repository_17_commit_data_01_import
#| echo: false
#| fig-cap: |
#|   A gif about data import.
#| fig-alt: |
#|   A gif about file import.
#|
knitr::include_graphics("new_repository_17_commit_data_01_import.gif")
```
:::

Arthur can continue adding files to his local repository and then pushing them to GitHub in this fashion for the remainder of the time he is working on this project, and the [introduction to git and GitHub chapter](../intro_git_github/intro_git_github.qmd) discusses _why_ he should consider doing so.
...
#| label: forking_01
#| echo: FALSE
knitr::include_graphics("forking_01.png")
```
...
knitr::include_graphics("forking_02.png")
```
...
knitr::include_graphics("forking_03.png")
```
...
knitr::include_graphics("forking_04.png")
```
...
knitr::include_graphics("forking_05.png")
```
...
```{r}
#| label: pull_request_01
#| echo: FALSE
knitr::include_graphics("pull_request_01.png")
```
...
```{r}
#| label: pull_request_02
#| echo: FALSE


knitr::include_graphics("pull_request_02.png")
```
...
```{r}
#| label: pull_request_03
#| echo: FALSE


knitr::include_graphics("pull_request_03.png")
```
...
```{r}
#| label: pull_request_04
#| echo: FALSE


knitr::include_graphics("pull_request_04.png")
```
...
```{r}
#| label: pull_request_05
#| echo: FALSE


knitr::include_graphics("pull_request_05.png")
```
...
```{r}
#| label: pull_request_06
#| echo: FALSE


knitr::include_graphics("pull_request_06.png")
```

The next time Arthur checks the `r4epi_example_project` on GitHub, he will see that he has a new pull request.

```{r}
#| label: pull_request_07 
#| echo: FALSE


knitr::include_graphics("pull_request_07.png")
```
...
```{r}
#| label: pull_request_08
#| echo: FALSE


knitr::include_graphics("pull_request_08.png")
```
...
```{r}
#| label: pull_request_09
#| echo: FALSE
knitr::include_graphics("pull_request_09.png")
```
...
```{r}
#| label: pull_request_10
#| echo: FALSE


knitr::include_graphics("pull_request_10.png")
```
...
```{r}
#| label: pull_request_11
#| echo: FALSE


knitr::include_graphics("pull_request_11.png")
```
...
```{r}
#| label: pull_request_12
#| echo: FALSE


knitr::include_graphics("pull_request_12.png")
```
...
```{r}
#| label: pull_request_15
#| echo: FALSE


knitr::include_graphics("pull_request_15.png")
```
...
```{r}
#| label: pull_request_16
#| echo: FALSE


knitr::include_graphics("pull_request_16.png")
```
...
```{r}
#| lable: pull_request_17
#| echo: FALSE


knitr::include_graphics("pull_request_17.png")
```
...
```{r}
#| label: pull_request_18
#| echo: FALSE


knitr::include_graphics("pull_request_18.png")
```
...
```{r}
#| label: pull_request_19
#| echo: FALSE


knitr::include_graphics("pull_request_19.png")
```
...
```{r}
#| label: pull_request_20
#| echo: FALSE


knitr::include_graphics("pull_request_20.png")
```
...
```{r}
#| label: pull_request_21
#| echo: FALSE


knitr::include_graphics("pull_request_21.png")
```
...
```{r}
#| label: pull_request_22
#| echo: FALSE


knitr::include_graphics("pull_request_22.png")
```
...
```{r}
#| label: pull_request_23
#| echo: FALSE


knitr::include_graphics("pull_request_23.png")
```

To do so, Brad will first click `Fetch upstream` followed by the green `Fetch and merge` button. 

```{r}
#| label: pull_request_24
#| echo: FALSE


knitr::include_graphics("pull_request_24.png")
```
...
```{r}
#| label: pull_request_25
#| echo: FALSE


knitr::include_graphics("pull_request_25.png")
```

...
To preview:
bookdown::preview_chapter("chapters/10_part_epi_foundations/06_measures_of_association.Rmd")
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_01.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/03_measures_of_occurrence/pop_10_plot.png")
```
...
ggsave(
  "img/10_part_epi_foundations/06_measures_of_association/pop_10_exposed_plot.png",
  pop_10_exposed_plot, 
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/pop_10_exposed_plot.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_02.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_03.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_04.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_05.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/crosstab_06.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/independence.png")
```
...
```{r measures-of-association-incidence-proportion-ratio-crosstab, fig.cap="Calculating incidence proportion ratios", echo=FALSE}
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/incidence_proportion_ratio_crosstab.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/incidence_proportion_difference_crosstab.png")
```
...
knitr::include_graphics("img/10_part_epi_foundations/06_measures_of_association/incidence_odds_ratio_crosstab.png")
```

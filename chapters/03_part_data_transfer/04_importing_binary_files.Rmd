...
```{r read-in-excel-xlsx, cache = TRUE}
...
```{r read-in-excel-complex-xlsx, cache = TRUE}
...
```{r read-in-excel-complex-xlsx-2, cache = TRUE}
excel <- read_excel(

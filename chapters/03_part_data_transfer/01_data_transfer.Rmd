...
In previous chapters you got an overview of SAS and some of its capabilities. You also learned to navigate the SAS user interface, and you even wrote your own simple program by directly inputting the data using the DATALINES statement (also called instream data), and storing your data set in the work library. But remember, anything stored in the work library will automatically be deleted at the end of a session. I think the limitations of having to create a SAS data set every time you start a new session are probably obvious to you.

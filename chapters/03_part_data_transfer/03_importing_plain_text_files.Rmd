...
```{r read-in-single-delimited-txt, cache = TRUE}
...
```{r read-in-single-delimited-txt-2, cache = TRUE}
single_space <- read_delim(
  file = "data/single_delimited.txt",
  delim = " ",
  na = "."
...
```{r read-in-tab-txt-2, cache = TRUE}
...
```{r read-in-fixed-width-txt, cache = TRUE}
...
```{r read-in-fixed-width-no-space-txt, cache = TRUE}
...
```{r read-in-fixed-width-no-space-txt-2, cache = TRUE}
fixed <- read_fwf(
...
```{r read-in-fixed-width-no-space-txt-3, cache = TRUE}
fixed <- read_fwf(
  file = "data/fixed_width_no_space.txt",
...
```{r read-in-fixed-width-no-space-txt-4, cache = TRUE, message=FALSE}
read_fwf(
  file = "data/fixed_width_no_space.txt",
...
```{r read-in-fixed-width-no-space-txt-5, cache = TRUE, message=FALSE}
read_fwf(
  file = "data/fixed_width_no_space.txt",
  col_positions = fwf_cols(
    id      = c(1, 3),
...
```{r read-in-comma-csv, cache = TRUE}
...
```{r read-in-comma-complex-csv, cache = TRUE}
...
```{r read-in-comma-complex-csv-2, cache = TRUE}
csv <- read_csv(
...
```{r read-in-comma-complex-csv-3, cache = TRUE}
csv <- read_csv(
  file = "data/comma_complex.csv",
  col_names = c("id", "sex", "ht_in", "wgt_lbs"),
  col_types = cols(
...
```{r read-in-comma-complex-csv-4, cache = TRUE}
csv <- read_csv(
  file = "data/comma_complex.csv",
  col_names = c("id", "sex", "ht_in", "wgt_lbs"),
  col_types = cols(
...
```{r read-in-comma-complex-csv-5, cache = TRUE}
csv <- read_csv(
  file = "data/comma_complex.csv",
  col_names = c("id", "sex", "ht_in", "wgt_lbs"),
  col_types = cols(

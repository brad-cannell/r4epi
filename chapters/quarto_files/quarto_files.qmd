...
::: callout-warning
## How Much Code in Each Code Chunk?
On platforms like RStudio or Positron, it’s good practice to separate code into smaller chunks — especially when using Quarto. Each chunk should typically perform one task or produce one piece of output. This keeps documents readable and ensures all results display correctly in the rendered document.
:::

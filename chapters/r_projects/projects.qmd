...
```{r}
#| label: create-01-icon
#| echo: FALSE


knitr::include_graphics("create_01_icon.png")
```
...
```{r}
#| label: create_02_new_project
#| echo: FALSE


knitr::include_graphics("create_02_new_project.png")
```
...
```{r}
#| label: create-03-new-directory
#| echo: FALSE


knitr::include_graphics("create_03_new_directory.png")
```

Next, we will click the `New Project` option.

```{r}
#| label: create-04-new-project
#| echo: FALSE


knitr::include_graphics("create_04_new_project.png")
```
...
```{r}
#| label: create-of-directory
#| echo: FALSE


knitr::include_graphics("create_05_directory.png")
```
...
```{r}
#| label: create-06-rproj-file
#| echo: FALSE


knitr::include_graphics("create_06_rproj_file.png")
```
...
knitr::include_graphics("open_rproj.png")
```
...
knitr::include_graphics("check_rproj.png")
```

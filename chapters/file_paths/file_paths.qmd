...
```{r}
#| label: file_paths_directions 
#| echo: FALSE
#| 
knitr::include_graphics("directions.png")
```
...
```{r}
#| label: file_paths_ntrhd
#| echo: FALSE


knitr::include_graphics("ntrhd.png")
```

And, my_study_data.csv is inside the NTRHD folder.

```{r}
#| label: file_paths_my_study_data
#| echo: FALSE


knitr::include_graphics("my_study_data.png")
```
...
```{r}
#| label: file_paths_get_info
#| echo: FALSE


knitr::include_graphics("get_info.png")
```

Now, we just copy the file path in the `Where` section of the get info window and paste it into our R code.

```{r}
#| label: file_paths_where
#| echo: FALSE


knitr::include_graphics("where.png")
```
...
```{r}
#| label: relative_file_paths_01_absolute_brad
#| echo: FALSE


knitr::include_graphics("relative_file_paths_01_absolute_brad.png")
```
...
```{r}
#| label: relative_file_paths_02_absolute_arthur
#| echo: FALSE


knitr::include_graphics("relative_file_paths_02_absolute_arthur.png")
```
...
```{r}
#| label: file_paths_directions_relative
#| echo: FALSE
...
```{r}
#| label: relative_file_paths_03_check_project
#| echo: FALSE


knitr::include_graphics("relative_file_paths_03_check_project.png")
```
...
```{r}
#| label: relative_file_paths_04_check_files
#| echo: FALSE


knitr::include_graphics("relative_file_paths_04_check_files.png")
```
...
```{r}
#| label: relative_file_paths_05_relative_path_brad
#| echo: FALSE


knitr::include_graphics("relative_file_paths_05_relative_path_brad.png")
```
...
```{r}
#| label: relative_file_paths_06_relative_path_arthur
#| echo: FALSE


knitr::include_graphics("relative_file_paths_06_relative_path_arthur.png")
```

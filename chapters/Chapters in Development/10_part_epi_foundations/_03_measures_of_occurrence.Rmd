...
To preview:
bookdown::preview_chapter("chapters/10_part_epi_foundations/03_measures_of_occurrence.Rmd")
...
```{r measures-of-occurrence-pop-10}
...
```{r measures-of-occurrence-pop-10-plot}
# Create the figure
...
```{r measures-of-occurrence-pop-10-plot-save, echo=FALSE}
...
ggsave(
  "img/10_part_epi_foundations/03_measures_of_occurrence/pop_10_plot.png",
  pop_10_plot, 
  width = 7.29, height = 4.51
)
```

```{r measures-of-occurrence-po-10-plot-prevalence-proportion, echo=FALSE}
...
# make them in one place.
ggsave(
  "img/10_part_epi_foundations/03_measures_of_occurrence/pop_12_plot.png",
  pop_12_plot, 
  width = 7.29, height = 4.51
)
```
...
knitr::include_graphics("img/10_part_epi_foundations/03_measures_of_occurrence/pop_12_plot.png")
```
...
# make them in one place.
ggsave(
  "img/10_part_epi_foundations/03_measures_of_occurrence/pop_10_censored_plot.png",
...
knitr::include_graphics("img/10_part_epi_foundations/03_measures_of_occurrence/pop_10_censored_plot.png")
```

...
```{r echo=FALSE}
knitr::include_graphics("img/fix_typo.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/propose_changes.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/create_pull_request_1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/create_pull_request_2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/create_pull_request_3.png")
```

When we open the pull request, we can see the proposed changes to the file.

```{r echo=FALSE}
knitr::include_graphics("img/create_pull_request_4.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/create_pull_request_5.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/issue_tracker.png")
```

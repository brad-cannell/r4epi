...
1. To teach you how to use R and RStudio as tools for applied epidemiology. It is not to turn you into a computer scientist or a hard-core R programmer. Therefore, some readders who are experienced programmers may catch some technical inacuracies on what I consider to be the fine points of what R is doing "under the hood."    
...
* **Bold** text is used to highlight important terms, URLs, email addresses, filenames, and file extensions.   

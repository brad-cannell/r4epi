...
* **Bold** text is used to highlight important terms, URLs, email addresses, file names, and file extensions.   
* `Highlighted inline code` is used to emphasize small sections of R code, program elements such as variable or function names, databases, data types, environment variables, statements, and keywords.   
